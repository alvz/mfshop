...
class TagController extends Controller {
    ...
    public function accessRules() {
        ...
        return array(
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete','index', 'view','create', 'update', 'updateTagsList'),
                'users' => $usernames,
            ),
    ...
    public function actionUpdateTagsList() {
        $model = new Tag;
        $model->name = $_POST['addTag'];

        try {
            if ($model->save()) {
                Yii::app()->user->setFlash('tagadded', 'Tag successfully added');
            }
        } catch (Exception $e) {
            Yii::app()->user->setFlash('tagexist', 'Tag already existed');
        }
        echo $this->renderPartial('_tagsList', null, FALSE, true);
    }
