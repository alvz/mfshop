...
class CommentProductController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['CommentProduct'])) {
            $model->attributes = $_POST['CommentProduct'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('CommentProduct', array(
                    'criteria' => array('condition' => 'product_id=:productID',
                        'params' => array(':productID' => $this->_product->id),
                    ),
    ...
    public function actionAdmin() {
        $model = new CommentProduct('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['CommentProduct']))
            $model->attributes = $_GET['CommentProduct'];
    ...
    public function loadModel($id) {
        $model = CommentProduct::model()->findByPk((int) $id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'comment-product-form') {
